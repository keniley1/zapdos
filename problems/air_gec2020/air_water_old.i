...
[DriftDiffusionActionAD]
  [./Plasma]
    electrons = em
    charged_particle = 'N2p N4p Np O2p O2m Om H2Op OHp OHm'
  ...
  [./Water]
    ...
    #charged_particle = 'em_aq OH- H2O+ O- H3O+ HO2- O2- O3- H+'
    #charged_particle = 'em_aq OH- H2O+ O- H3O+ HO2- O2- O3- H+ Na+ Cl- Arp_aq'
    #Neutrals = 'H OH H2 H2O2 O2 O HO2 O3 Ar_aq'
    charged_particle = 'em_aq OHm_aq'
    Neutrals = 'OH_aq H2O2_aq'
    is_potential_unique = false
    potential = potential
    using_offset = true
    offset = 30
...
[Reactions]
  ...
  # Hs* = H(2p)
  [gas_reactions]
    species = 'em N2v N2p N4p N2s N2ss N2sss N Ns Np O2p O2m O2s Om O Os H2O H2Op H2 H Hs O3 HO2 H2O2 NO NO2 N2O NO3 N2O3 N2O4 N2O5 OHm OHp OH OHs'
    aux_species = 'N2 O2'
    ...
    reactions = 'em + N2 -> em + N2               : EEDF [elastic] (C1_N2_Elastic)
                 ...
                 # Cannot find these cross sections
                 #em + O2 -> em + O + O            : EEDF [] (C_O2_Excitation__eV)
                 #em + O2s -> em + O + O           : EEDF [] (C_O2_Excitation__eV)
                 ...
                 OH + OH + N2 -> H2O2 + N2        : {6.9e-31*Tn^(-0.8)} 
                 OHs + OHs + N2 -> H2O2 + N2      : {6.9e-31*Tn^(-0.8)} 
                 ...
                 HO2 + HO2 + N2 -> H2O2 + O2 + N2 : {1.9e-33*exp(980/Tgas)}
  ...
  [water_reactions]
    ...
    #
    # Od1 + H2O_aq -> H2O2_aq      : 1.8e7
    # Od1 + H2O_aq -> OH_aq + OH_aq   : 2.3e-13
    #
    #species = 'em_aq OHm_aq Om_aq O2m_aq O3m_aq HO2m_aq Hp_aq O_aq O2_1_aq O3_aq H_aq H2_aq HO2_aq HO3_aq OH_aq H2O2'
    #species = 'em_aq OHm_aq Om_aq O2m_aq O3m_aq HO2m_aq Hp_aq O_aq O3_aq H_aq H2_aq HO2_aq HO3_aq OH_aq H2O2'
    species = 'em_aq OHm_aq OH_aq H2O2_aq'
    aux_species = 'H2O_aq'
    use_log = true
    position_units = ${dom1Scale}
    track_rates = false
    ...
    reactions = 'em_aq + em_aq -> H2_aq + OHm_aq + OHm_aq    : 5.5e6
                 OH_aq + OH_aq -> H2O2_aq                    : 3.6e6'
    #reactions = 'em_aq + em_aq -> H2_aq + OHm_aq + OHm_aq    : 5.5e6
                 #em_aq + em_aq -> H2_aq + OH- + OH-      : 3.0703e8
                 #H2O_aq -> Hp_aq + OHm_aq            : 1.4e-3
                 #Hp_aq + OHm_aq -> H2O_aq            : 1.4e8
                 #H2O2_aq -> Hp_aq + HO2m_aq          : 1.12e-1
                 #Hp_aq + HO2m_aq -> H2O2_aq          : 5e7
                 #HO2_aq -> O2m_aq + Hp_aq            : 1.35e6
                 #O2m_aq + Hp_aq -> HO2_aq            : 5e7
                 #OH_aq -> Om_aq + Hp_aq              : 1.26e-1
                 #Om_aq + Hp_aq -> OH_aq              : 1e8
                 #OH_aq + OHm_aq -> H2O_aq + Om_aq       : 1.3e7
                 #H2O_aq + Om_aq -> OH_aq + OHm_aq       : 1.7e3
                 #H2O2_aq + OHm_aq -> HO2m_aq + H2O_aq   : 1.3e7
                 #HO2m_aq + H2O_aq -> H2O2_aq + OHm_aq   : 5.8e4
                 #em_aq + H2O_aq -> H_aq + OHm_aq     : 1.9e-2
                 #H_aq + OHm_aq -> H2O_aq + em_aq     : 2.2e4
                 #OH_aq + OHm_aq -> Om_aq + H2O_aq       : 1.3e7
                 #Om_aq + H2O_aq -> OH_aq + OHm_aq       : 1.03e5
                 #HO2_aq + OHm_aq -> O2m_aq + H2O_aq     : 5.0e7
                 #O2m_aq + H2O_aq -> HO2_aq + OHm_aq     : 18.5767e-3
                 #Om_aq + O2_aq -> O3m_aq             : 3.6e6
                 #O3m_aq -> Om_aq + O2_aq             : 3.3e3
                 #OH_aq + OH_aq -> H2O2_aq            : 3.6e6
                 #H2O2_aq -> OH_aq + OH_aq            : 2.3e-7
                 #H_aq -> em_aq + Hp_aq            : 3.9
                 #em_aq + Hp_aq -> H_aq            : 2.3e7
                 #O_aq + O2_aq -> O3_aq               : 4.0e6
                 #O_aq + O_aq -> O2_aq                : 2.8e7
                 ##O2_1_aq + H2O_aq -> O2_aq + H2O_aq     : 4.9
                 ##O2_1_aq + OH_aq -> O2_aq + OH_aq       : 2.2
                 #em_aq + OH_aq -> OHm_aq          : 3.0e7
                 #em_aq + H2O2_aq -> OH_aq + OHm_aq   : 1.1e7
                 #em_aq + HO2_aq -> HO2m_aq        : 2.0e7
                 #em_aq + O2_aq -> O2m_aq          : 1.9e7
                 #em_aq + HO2m_aq -> Om_aq + OHm_aq   : 3.5e7
                 #em_aq + O3_aq -> O3m_aq          : 3.6e7
                 #H_aq + H2O_aq -> H2_aq + OH_aq         : 1.1e7
                 #H_aq + Om_aq -> OHm_aq              : 1.0e7
                 #H_aq + HO2m_aq -> OHm_aq + OH_aq       : 9.0e7
                 #H_aq + O3m_aq -> OHm_aq + O2_aq        : 1.0e7
                 #H_aq + H_aq -> H2_aq                : 7.8e6
                 #H_aq + OH_aq -> H2O_aq              : 7.0e6
                 #H_aq + O2_aq -> HO2_aq              : 2.1e7
                 #H_aq + H2O2_aq -> OH_aq + H2O_aq       : 9.0e4
                 #H_aq + HO2_aq -> H2O2_aq            : 1.8e7
                 #H_aq + O2m_aq -> HO2m_aq            : 1.8e7
                 #H_aq + O3_aq -> HO3_aq              : 3.8e7
                 #OH_aq + HO2_aq -> O2_aq + H2O_aq         : 6.0e6
                 #OH_aq + O2m_aq -> O2_aq + OHm_aq         : 8.2e6
                 #OH_aq + H2_aq -> H_aq + H2O_aq           : 4.3e4
                 #OH_aq + H2O2_aq -> HO2_aq + H2O_aq       : 2.7e4
                 #OH_aq + Om_aq -> HO2m_aq              : 2.5e7
                 #OH_aq + HO2m_aq -> HO2_aq + OHm_aq       : 6.0e6
                 #OH_aq + O3m_aq -> O3_aq + OHm_aq         : 2.6e6
                 ##OH_aq + O3m_aq -> O2_aq + O2_aq + Hp_aq     : 6.0e6
                 #OH_aq + O3m_aq -> O2m_aq + O2m_aq + Hp_aq     : 6.0e6
                 #OH_aq + O3_aq -> HO2_aq + O2_aq          : 1.1e5
                 #HO2_aq + O2m_aq -> HO2m_aq + O2_aq       : 8.0e4
                 #HO2_aq + HO2_aq -> H2O2_aq + O2_aq       : 7.0e2
                 #HO2_aq + Om_aq -> O2_aq + OHm_aq         : 6.0e6
                 #HO2_aq + H2O2_aq -> OH_aq + O2_aq + H2O_aq        : 0.5e-3
                 #HO2_aq + HO2m_aq -> OHm_aq + OH_aq + O2_aq        : 0.5e-3
                 #O2m_aq + H2O2_aq -> OH_aq + O2_aq + OHm_aq        : 0.13e-3
                 #O2m_aq + HO2m_aq -> Om_aq + O2_aq + OHm_aq        : 0.13e-3
                 #O2m_aq + O3_aq -> O3m_aq + O2_aq               : 1.5e6
                 #Om_aq + H2_aq -> H_aq + OHm_aq                 : 8.0e4
                 #Om_aq + H2O2_aq -> H2O_aq + O2m_aq             : 5.0e5
                 #Om_aq + HO2m_aq -> OHm_aq + O2m_aq             : 4.0e5
                 #Om_aq + O3m_aq -> O2m_aq + O2m_aq              : 7.0e5
                 #Om_aq + O3_aq -> O2m_aq + O2_aq                : 5.0e6
                 #O3m_aq + Hp_aq -> O2_aq + OH_aq                 : 9.0e6
                 #HO3_aq -> O2_aq + OH_aq                     : 1.0e5
                 #O_aq + OHm_aq -> HO2m_aq                    : 1.1e2
                 #O_aq + H2O2_aq -> OH_aq + HO2_aq               : 1.6e2
                 #O_aq + HO2m_aq -> OH_aq + O2m_aq               : 5.3e6
                 #O3_aq + H2O2_aq -> OH_aq + HO2_aq + O2_aq         : 3.0e6
                 #em_aq + O2m_aq -> HO2m_aq + OHm_aq          : 1.3e7
                 #em_aq + H_aq -> H2_aq + OHm_aq              : 2.5e7
                 #em_aq + Om_aq -> OHm_aq + OHm_aq            : 2.2e7
                 ##em_aq + O3m_aq -> O2_aq + OH_aq + OH_aq        : 1.6e7
                 #em_aq + O3m_aq -> O2_aq + OHm_aq + OHm_aq      : 1.6e7
                 #Om_aq + O2m_aq -> OHm_aq + OHm_aq + O2_aq         : 6.0e4
                 #O2m_aq + O3m_aq -> OHm_aq + OHm_aq + O2_aq + O2_aq   : 1.0e1
                 #Om_aq + Om_aq -> OHm_aq + HO2m_aq              : 1.0e6
                 #O2m_aq + O2m_aq -> H2O2_aq + O2_aq + OHm_aq + OHm_aq : 1.0e-1'
  []
[]
