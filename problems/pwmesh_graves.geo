...
Point(4) = {0.001 * dom0Mult, 0, 0, lc/12000};
...
Point(800) = {0 * dom0Mult, 1e-5 * dom0Mult, 0.0, lc / 800};
...
// Water Boundary
Point(40) = {0.001 * dom0Mult, -1.0e-6 * dom0Mult, 0, lc/6000};
Point(80) = {0.0, -1.0e-6 * dom0Mult, 0, lc/16000};
Line(440) = {4,40};
Line(4080) = {40,80};
Line(808) = {80,8};
