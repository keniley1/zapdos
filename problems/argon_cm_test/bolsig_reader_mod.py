...
# Townsend
#read_bolsig("argon_out.dat", "cs.txt", runs=500, gas_density=2.445692e25, coefficient_type="townsend", transport_factor=1, rate_factor=1)

# Rate
read_bolsig("argon_out.dat", "cs.txt", runs=500, gas_density=2.445692e25, coefficient_type="rate", transport_factor=1, rate_factor=1)
