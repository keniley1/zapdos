...
for v in voltage:
    ...
    em_density = np.exp(exopy.get_vals('em', data_type='node')[:,block0])*6.022e23
    arp_density = np.exp(exopy.get_vals('Arp', data_type='node')[:,block0])*6.022e23
    ...
    O3_density = np.exp(exopy.get_vals('O3', data_type='node')[:,block1])*6.022e23
    H2_density = np.exp(exopy.get_vals('H2', data_type='node')[:,block1])*6.022e23
    OH_density = np.exp(exopy.get_vals('OH', data_type='node')[:,block1])*6.022e23
    H2O2_density = np.exp(exopy.get_vals('H2O2', data_type='node')[:,block1])*6.022e23
    ...
    ax1.semilogy(x0*1e3, em_density[-1, :], 'k', label='e')
    ax1.semilogy(x0*1e3, arp_density[-1, :], 'r', label='Ar$^+$')
    ...
    ax2.semilogy(x1*1e3, OHm_density[-1, :], label='OH$^-$')
    ax2.semilogy(x1*1e3, Hp_density[-1, :], label='H$^+$')
    ax2.semilogy(x1*1e3, O3_density[-1, :], label='O$_3$')
    ax2.semilogy(x1*1e3, H2_density[-1, :], label='H$_2$')
    ax2.semilogy(x1*1e3, H2O2_density[-1, :], label='H$_2$O$_2$')
...
#plt.show()
#exit()
plt.savefig('plots/all_species_1kv_gopalakrishnan_022.png', dpi=200, bbox_inches='tight')
plt.close()
exit()
