...
Point(3) = {0.001 * dom0Mult, 0.0013 * dom0Mult, 0.0, lc/30};

// Lower right of boundary (right side of liquid interface)
Point(4) = {0.001 * dom0Mult, 0, 0, lc/800}; 
Point(43) = {0.001 * dom0Mult, 0.0002 * dom0Mult, 0.0, lc/40};

Point(6) = {0.0003 * dom0Mult, 0.0013 * dom0Mult, 0, lc/1000};
//Point(8) = {0.0, 0, 0, lc/2500000};
//Point(8) = {0.0, 0, 0, lc/625000 * 10};
Point(8) = {0.0, 0, 0, lc/800};
//Point(81) = {0.0008 * dom0Mult, 0, 0, lc/4000};
Point(81) = {0.0008 * dom0Mult, 0, 0, lc/800};
...
Point(12) = {0 * dom0Mult, 0.001 * dom0Mult, 0, lc/1000};
...
// Water Boundary
Point(40) = {0.001 * dom0Mult, -1.5e-5 * dom0Mult, 0, lc/400};
