...
[Variables]
  ...
  [Clm_aq]
    ...
    # 21 mM -- 1 mM added for decreased pH
    initial_condition = 3.0462
  [] 
  ...
  ################################
  # GAS PHASE
  # background gas: Argon
  # impurities: 1 ppm O2
  #             1 ppm H2O (overridden by evaporation?)
  #             0.5 ppm total hydrocarbons (THC) -- not included
  #             5 ppm N2 -- not included, might be necessary?
  #             1 ppm CO-CO2 -- not included 
  [H2O]
    block = 0
    order = SECOND
