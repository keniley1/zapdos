...
[BCs]
  ...
  [H2O_interface]
    type = DirichletBC
    variable = H2O
    #value = -0.900556 # 1 % humidity
    #value = -0.2074 # 2 % humidity
    #value = 0.70881 # 5 % humidity
    value = 1.402028 # 10 % humidity
    boundary = 'gas_right'
  []
...
[Materials]
 ...
 [./GasBasics]
   ...
   property_tables_file = 'bolsig_files_10/electron_mobility_diffusion.txt'
   block = 0
 [../]
 [gas_constants]
   type = GenericConstantMaterial
