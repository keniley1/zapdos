...
[Materials]
 ...
 [./GasBasics]
   ...
   mean_en = mean_en
   user_se_coeff = 0.05
   property_tables_file = 'bolsig_files_065/electron_mobility_diffusion.txt'
   block = 0
 [../]
 [gas_constants]
   type = GenericConstantMaterial
...
[Reactions]
  [./Argon]
    ...
    species = 'em Arp Ar2p Ars Arss Arsss OH H2O O2 O2p O2m O2s Om O Os H2O H2Op H2 H Hs O3 HO2 H2O2 OHm OHp OHs Hp Op'
    aux_species = 'Ar'
    ...
    file_location = 'bolsig_files_065'
