...
[Reactions]
  ...
  [./water_reactions]
    ...
    reactions = 'em_aq + H2O_aq -> H + OHm_aq               : 1.9e-2
                 #em_aq + H2O+ -> H + OH               : 6e8
                 #em_aq + em_aq -> H2 + OHm_aq + OHm_aq      : 5.5e9
                 em_aq + em_aq -> H2 + OHm_aq + OHm_aq      : 3.0703e8'
                 #em_aq + H + H2O_aq -> H2 + OHm_aq          : 2.5e4
                 #em_aq + OH -> OHm_aq                    : 3e7
                 #em_aq + O- + H2O_aq -> OH + OH          : 2.2e4
                 #em_aq + H3O+ -> H + H2O_aq              : 2.3e7
                 #em_aq + H2O2 -> OH + OHm_aq             : 1.1e7
                 #em_aq + HO2- + H2O_aq -> OH + OHm_aq + OHm_aq : 3.5e3
                 #em_aq + O2 -> O2-                    : 1.9e7
                 #em_aq + O -> O-                      : 1.9e7
                 #H + H2O_aq -> H2 + OH                   : 1e-2
                 #H + H -> H2                          : 7.5e6
                 #H + OH -> H2O_aq                        : 7e6
                 #H + OHm_aq -> H2O_aq + em_aq               : 2.2e4
                 ...
                 #OH + OHm_aq -> O- + H2O_aq                 : 1.3e7
                 #OH + HO2 -> O2 + H2O_aq                 : 6e6
                 #OH + O2- -> O2 + OHm_aq                 : 8e6
                 #O- + H2O_aq -> OHm_aq + OH                 : 1.8e3
                 #O- + H2 -> OHm_aq + H                   : 8e4
                 #O- + H2O2 -> O2- + H2O_aq               : 5e5
                 #O- + HO2- -> O2- + OHm_aq               : 4e5
                 #O- + O2 -> O3-                       : 3.6e6
                 #O- + O2- + H2O_aq -> OHm_aq + OHm_aq + O2     : 6e2
                 #OH + H2O2 -> H2O_aq + HO2               : 2.7e4
                 #OH + HO2- -> OHm_aq + HO2               : 7.5e6
                 #H2O+ + H2O_aq -> H3O+ + OH              : 6
                 #H3O+ + OHm_aq -> H2O_aq + H + OH           : 6e7
                 #HO2 + H2O_aq -> H3O+ + O2-              : 2
                 #H3O+ + O2- -> H2O_aq + HO2              : 6e-2
                 ##em_aq + NO2- -> NO2_2-               : 5.2e6
                 ##em_aq + NO3- -> NO3_2-               : 7e6
                 #H2O_aq -> H+ + OHm_aq                      : 1.3963e-3
                 #H+ + OHm_aq -> H2O_aq                      : 1.3973e8'
  [../]
  ...
  [water2]
    ...
    reactions = 'em_aq + H2O_aq -> H_aq + OHm_aq            : 1.9e-2
                 ...
                 # although I am starting to doubt those values...
                 #################################
