...
[Preconditioning]
  ...
  [./smp]
    type = SMP
    #full = true
    off_diag_row = '   em  Arp  em  Ar* potential potential potential  OHm   emliq H2    emliq emliq mean_en mean_en   em        Arp       em       Arp     Arp mean_en'
    off_diag_column = 'Arp em   Ar* em  em        Arp       emliq      emliq O2m   emliq H2O2  HO2m  em      potential potential potential mean_en  mean_en Ar* Ar*'
...
[Variables]
  ...
  [./em]
    ...
    initial_from_file_timestep = 341
    block = 0
  [../]
  ...
  [./OHm]
    ...
    initial_from_file_var = OHm
    initial_from_file_timestep = 341
  [../]
  [./Om]
    block = 1
    #initial_condition = -31
    initial_from_file_var = Om
    initial_from_file_timestep = 341
  [../]
