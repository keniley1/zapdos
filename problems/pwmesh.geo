...
Point(3) = {0.002 * dom0Mult, 0.002 * dom0Mult, 0.0, lc/6};
...
Point(81) = {0.001 * dom0Mult, 0, 0, lc/4000};
...
Point(12) = {0 * dom0Mult, 0.00100294555 * dom0Mult, 0, lcp*5};
...
Point(800) = {0 * dom0Mult, 1e-5 * dom0Mult, 0.0, lc / 200};
...
Point(80) = {0.0, -1.5e-5 * dom0Mult, 0, lc/400};
Line(440) = {4,40};
Line(4080) = {40,80};
Line(808) = {80,8};
