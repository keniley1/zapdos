...
# Townsend
#read_bolsig("argon_out.dat", "comsol_cs.txt", runs=100, gas_density=2.44746e25, coefficient_type="townsend", transport_factor=1, rate_factor=1)

# Townsend
read_bolsig("argon_out.dat", "comsol_cs.txt", runs=100, gas_density=2.43839e25, coefficient_type="townsend", transport_factor=1, rate_factor=1)

# Rate
#read_bolsig("argon_out.dat", "comsol_cs.txt", runs=100, gas_density=2.43839e25, coefficient_type="rate", transport_factor=1, rate_factor=1)
