...
#include "AddDriftDiffusionActionAD.h"
#include "Parser.h"
#include "FEProblem.h"
#include "Factory.h"
#include "MooseEnum.h"
...
registerMooseAction("ZapdosApp", AddDriftDiffusionActionAD, "add_variable");
registerMooseAction("ZapdosApp", AddDriftDiffusionActionAD, "add_kernel");
registerMooseAction("ZapdosApp", AddDriftDiffusionActionAD, "add_aux_kernel");

template <>
InputParameters
validParams<AddDriftDiffusionActionAD>()
{
...
AddDriftDiffusionActionAD::AddDriftDiffusionActionAD(InputParameters params)
...
void
AddDriftDiffusionActionAD::addElectronKernels(const std::string & em_name,
...
/*void
AddDriftDiffusionActionAD::addElectronADKernels(const std::string & em_name,
                                         const std::string & potential_name,
                                         const std::string & mean_en_name,
                                         const bool & Using_offset)
{
...
void
AddDriftDiffusionActionAD::addChargedParticlesKernels(const std::string & ion_name,
                                                    const std::string & potential_name,
                                                    const bool & Using_offset)
{
  InputParameters params = _factory.getValidParams("ElectronTimeDerivative");
...
/*void
AddDriftDiffusionActionAD::addChargedParticlesADKernels(const std::string & ion_name,
                                                 const std::string & potential_name,
                                                 const bool & Using_offset)
{
}*/
...
void
AddDriftDiffusionActionAD::addNeutralParticlesKernels(const std::string & neutral_name,
                                                    const bool & Using_offset)
{
  InputParameters params = _factory.getValidParams("ElectronTimeDerivative");
...
/*AddDriftDiffusionActionAD::addNeutralParticlesADKernels(const std::string & ion_name,
                                                 const std::string & potential_name,
                                                 const bool & Using_offset)
{
}*/
...
void
AddDriftDiffusionActionAD::addMeanEnergyKernels(const std::string & em_name,
                                              const std::string & potential_name,
                                              const std::string & mean_en_name,
                                              const bool & Using_offset)
{
...
void
AddDriftDiffusionActionAD::addChargeSourceKernels(const std::string & potential_name,
...
void
AddDriftDiffusionActionAD::addADKernels(const std::string & name,
                                      const std::string & potential_name,
                                      const bool & Using_offset,
                                      const bool & charged,
                                      const bool & energy)
...
void
AddDriftDiffusionActionAD::addPosition(const std::string & position_name, const int & component)
{
...
void
AddDriftDiffusionActionAD::addDensityLog(const std::string & particle_name)
{
...
void
AddDriftDiffusionActionAD::addCurrent(const std::string & particle_name,
                                    const std::string & potential_name)
{
...
void
AddDriftDiffusionActionAD::addEfield(const std::string & Efield_name,
                                   const std::string & potential_name,
                                   const int & component)
{
