...
#include "GasElectronMomentsLinear.h"
#include "MooseUtils.h"

registerADMooseObject("ZapdosApp", GasElectronMomentsLinear);

InputParameters
GasElectronMomentsLinear::validParams()
{
...
GasElectronMomentsLinear::GasElectronMomentsLinear(const InputParameters & parameters)
...
void
GasElectronMomentsLinear::computeQpProperties()
{
