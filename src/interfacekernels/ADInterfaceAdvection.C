...
#include "ADInterfaceAdvection.h"
#include "ADUtils.h"

registerMooseObject("ZapdosApp", ADInterfaceAdvection);

InputParameters
ADInterfaceAdvection::validParams()
{
...
ADInterfaceAdvection::ADInterfaceAdvection(const InputParameters & parameters)
  : ADInterfaceKernel(parameters),
    ...
    _grad_potential_neighbor(adCoupledGradient("potential_neighbor")),
...
ADReal
ADInterfaceAdvection::computeQpResidual(Moose::DGResidualType type)
{
  ADReal r = 0;
