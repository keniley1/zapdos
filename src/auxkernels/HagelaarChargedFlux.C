...
#include "HagelaarChargedFlux.h"
#include "Assembly.h"

registerMooseObject("ZapdosApp", HagelaarChargedFlux);

template <>
InputParameters
validParams<HagelaarChargedFlux>()
{
...
HagelaarChargedFlux::HagelaarChargedFlux(const InputParameters & parameters)
...
Real
HagelaarChargedFlux::computeValue()
{
  ...
  return _u_old[_qp] + (_ion_flux - _electron_flux) * 6.022e23 * 1.602e-19 * _dt * 0.001;
}
