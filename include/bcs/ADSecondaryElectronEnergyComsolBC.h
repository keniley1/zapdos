...
class ADSecondaryElectronEnergyComsolBC;

declareADValidParams(ADSecondaryElectronEnergyComsolBC);

class ADSecondaryElectronEnergyComsolBC : public ADIntegratedBC
{
public:
  static InputParameters validParams();
  ADSecondaryElectronEnergyComsolBC(const InputParameters & parameters);
